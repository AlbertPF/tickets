<!-- Modal -->
<div id="modal-nueva-actividad" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="success-header-modalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <form id="guardarActividad">
                @csrf
                <input type="hidden" name="tipo_formulario" id="tipo_formulario" value="">
                <input type="hidden" name="id_act_editar" id="id_act_editar" value="">
...
<script>
    $(document).ready(function() {
        ...
        $('.agregar_act').click(function() {
            ...
            $("#title_modal").html('Agregar Nueva Actividad');
    ...
    function registrar_act() {
        ...
        Swal.fire({
            ...
            preConfirm: () => {
                ...
                let formElement = document.getElementById("guardarActividad");
                let formData = new FormData(formElement);
                return fetch('{{ route('act.registrar') }}', {
                    method: "POST",
                    body: formData,
                    headers: {
    ...
    function editar_act() {
        ...
        $("#alternative-page-datatable tbody").on('click', '.editar_act', function() {
            let id_actividad = $(this).attr('data-id-act');
            //console.log(id_rlaboral);
            
            $("#tipo_formulario").val(2);
            $("#id_act_editar").val(id_actividad);

            $.ajax({
                type: 'POST',
                url: '{{ route('act.editar') }}',
                data: {
                ...
                success: function(data) {
                    ...
                    $("#modal-nueva-actividad").modal('show');
                }
            });
        });
    }
