...
@section('contenido')
            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Régimen Laboral</li>
                    </ol>
                </div>
                <h4 class="page-title">Régimen Laboral</h4>
            </div>
        </div>
    </div>
    <!-- end page title --> 
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-xl-9 col-lg-10">
                            <h4 class="header-title">Lista de Régimen Laboral</h4>
                            <p class="text-muted font-14" style="text-align: justify;">
                                El Gobierno Regional de Apurímac cuenta con diferentes regímenes laborales que rigen el trabajo de sus empleados. 
                                Estos regímenes son establecidos según las normativas vigentes y están diseñados para asegurar condiciones justas 
                        ...
                        <div class="col-xl-3 col-lg-2">
                            <div class="d-grid">
                                ...
                                <button type="button" class="btn btn-success agregar_rlaboral" data-bs-toggle="modal"
                                    data-bs-target="#modal-nueva-rl"><i class="mdi mdi-notebook-plus me-2"></i>
                                    Nuevo Régimen</button>
                            </div>
                        </div>
                    </div>
    ...
    @include('admin.regimen_laboral.modal')
...
@section('js-styles-home')
    <script>
        ...
        function eliminar_rlaboral() {
            $("#alternative-page-datatable tbody").on('click', '.eliminar_rlaboral', function() {
                let id_rl = $(this).attr('data-id-rlaboral');
                Swal.fire({
                    title: '¿Estás seguro?',
                    ...
                    preConfirm: () => {
                        ...
                        return fetch('{{ route('rlaboral.eliminar') }}', {
                            method: "POST",
                            body: JSON.stringify({
                                id_rl: id_rl
                            }),
