                                    ...
                                    <div class="row">
                                        <div class="col-4">
                                            ...
                                            <div class="d-flex">
                                                <i class='mdi mdi-card-account-details font-18 text-primary me-1'></i>
                                                <div>
                                                    <h5 class="mt-1 font-14 usuario"></h5>
                                                </div>
                                            </div>
                                            <!-- end due date -->
                                        </div> <!-- end col -->
                                        ...
                                        <div class="col-4">
                                            ...
                                            <div class="d-flex">
                                                <i class='mdi mdi-card-account-details-outline font-18 text-primary me-1'></i>
                                                <div>
                                                    <h5 class="mt-1 font-14 usuarioApePat"></h5>
                                                </div>
                                            </div>
                                            <!-- end due date -->
                                        </div> <!-- end col -->
                                        ...
                                        <div class="col-4">
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <i class='mdi mdi-card-account-details-outline font-18 text-primary me-1'></i>
                                                <div>
                                                    <h5 class="mt-1 font-14 usuarioApeMat"></h5>
                                                </div>
                                            </div>
                                            <!-- end assignee -->
                                        </div> <!-- end col -->
...
<script>
    ...
    function ver_AsigTicketsGeneral() {
        $("#selection-datatable tbody").on('click', '.ver_ticketAsigGeneral', function() {
            let id_Asigticket = $(this).attr('data-id-ticketAsig');
            //console.log(id_archivo);

            $.ajax({
                type: 'GET',
                url: '{{ route('ver.ticketsAsigGeneral') }}',
                data: {
    ...
    function verDataAsigTickets(data) {
        ...
        $('.usuario').html(data.tickets.usuario.nombre);
        $('.usuarioApePat').html(data.tickets.usuario.apellidoPaterno);
        $('.usuarioApeMat').html(data.tickets.usuario.apellidoMaterno);
