...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        async function startInteraction() {
            try {
                const response = await fetch('/gr-tickets/public/api/chatbot/start', {
                    method: 'POST',
                    headers: {
        ...
        async function endInteraction() {
            if (interactionId) {
                try {
                    await fetch('/gr-tickets/public/api/chatbot/end-interaction', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
        ...
        async function sendMessage() {
            ...
            try {
                const response = await fetch('/gr-tickets/public/api/chatbot/message', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content
